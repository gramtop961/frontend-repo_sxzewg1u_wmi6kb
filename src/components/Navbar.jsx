  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/40 border-b border-white/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="#home" className="font-extrabold text-xl tracking-tight" style={{
        ...
        <nav className="hidden md:flex items-center gap-6 text-gray-700">
          <a href="#home" className="hover:text-gray-900 transition inline-flex items-center gap-2"><Home size={18}/> Home</a>
          <a href="#projects" className="hover:text-gray-900 transition">Projects</a>
          <a href="#causes" className="hover:text-gray-900 transition">Our Work</a>
